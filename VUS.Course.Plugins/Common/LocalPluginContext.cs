...
using VUS.Course.Shared.Common;
...
namespace VUS.Course.Plugins.Common
{
    ...
    public class LocalPluginContext : ILocalPluginContext
    {
        ...
        private IOrganizationService _currentUserService;
        private IOrganizationService _systemUserService;
        ...
        public IPluginExecutionContext PluginExecutionContext =>
            _pluginExecutionContext ??
                (_pluginExecutionContext = (IPluginExecutionContext)ServiceProvider.GetService(typeof(IPluginExecutionContext)));
        ...
        /// </summary>
        public IOrganizationService CurrentUserService =>
            _currentUserService ??
                (_currentUserService = OrganizationServiceFactory.CreateOrganizationService(PluginExecutionContext.UserId));

        /// <summary>
        ///     The Microsoft Dynamics 365 organization service in System User context.
        /// </summary>
        public IOrganizationService SystemUserService =>
            _systemUserService ??
                (_systemUserService = OrganizationServiceFactory.CreateOrganizationService(null));
        ...
        public IServiceEndpointNotificationService NotificationService =>
            _notificationService ??
                (_notificationService = (IServiceEndpointNotificationService)ServiceProvider.GetService(typeof(IServiceEndpointNotificationService)));
