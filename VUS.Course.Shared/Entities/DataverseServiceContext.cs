...
namespace VUS.Course.Shared
{
	...
	public partial class DataverseServiceContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="VUS.Course.Shared.Contact"/> entities.
		/// </summary>
		public System.Linq.IQueryable<VUS.Course.Shared.Contact> ContactSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<VUS.Course.Shared.Contact>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="VUS.Course.Shared.vus_class"/> entities.
		/// </summary>
		public System.Linq.IQueryable<VUS.Course.Shared.vus_class> vus_classSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<VUS.Course.Shared.vus_class>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="VUS.Course.Shared.vus_course"/> entities.
		/// </summary>
		public System.Linq.IQueryable<VUS.Course.Shared.vus_course> vus_courseSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<VUS.Course.Shared.vus_course>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="VUS.Course.Shared.vus_enrollment"/> entities.
		/// </summary>
		public System.Linq.IQueryable<VUS.Course.Shared.vus_enrollment> vus_enrollmentSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<VUS.Course.Shared.vus_enrollment>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="VUS.Course.Shared.vus_student"/> entities.
		/// </summary>
		public System.Linq.IQueryable<VUS.Course.Shared.vus_student> vus_studentSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<VUS.Course.Shared.vus_student>();
			}
		}
	}
